...
function ProductDetail() {
  const [currentVariant, setCurrentVariant] = useState("XS");
  ...
  return (
    <div className="bg-base-100 p-3 mx-3 rounded-sm xs:mx-[clamp(0.75rem,6vw,7.5rem)] lg:mx-30 shadow-xl">
              ...
              <div className="flex flex-row items-center">
                ...
                <details className="dropdown">
                  ...
                  <ul className="menu dropdown-content bg-base-100 rounded-box z-1 w-52 p-2 shadow-sm">
                    <li>
                      <a onClick={() => setCurrentVariant("XS")}>XS</a>
                    </li>
                    <li>
                      <a onClick={() => setCurrentVariant("S")}>S</a>
                    </li>
                    <li>
                      <a onClick={() => setCurrentVariant("M")}>M</a>
                    </li>
                    <li>
                      <a onClick={() => setCurrentVariant("L")}>L</a>
                    </li>
                    <li>
                      <a onClick={() => setCurrentVariant("XL")}>XL</a>
                    </li>
                  </ul>
                </details>
              </div>
      ...
      <div className="my-2">{/*<ItemCarousel />*/}</div>
      <ChatButton />
    </div>
  );
}
