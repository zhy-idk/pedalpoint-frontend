  ...
  return (
      ...
      <div className="card-body">
        <h2 className="card-title">
          ...
          <div className="text-xs">Person 1</div>
        </h2>
        <p className="line-clamp-3">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quae quod aliquid pariatur, cumque dolorum quidem asperiores magnam maiores voluptatibus reiciendis nostrum culpa excepturi repudiandae, at, voluptatem quasi modi. Quasi, saepe.</p>
      </div>
    </div>
  );
}
